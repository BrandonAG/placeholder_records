...
router.get('/', async (req, res) => {
    try {
        // Get the results
        const [rows] = await connection.query(`CALL select_all_artists()`);
...
router.delete('/:id', async (req, res) => {
    try {
        ...
        const [rows] = await connection.query(`CALL delete_artists(${id})`);
...
router.post('/', async (req, res) => {
   try {
        ...
        const [rows] = await connection.query(`CALL insert_artist(?)`, [artist_name]);
